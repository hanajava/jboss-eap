...
echo "$JBOSS_HOME/bin/jboss-cli.sh --connect $USERPASS --controller=$DOMAIN_MASTER_ADDR:$DOMAIN_MASTER_PORT --command=/host=$HOST_NAME:shutdown"
$JBOSS_HOME/bin/jboss-cli.sh --connect $USERPASS --controller=$DOMAIN_MASTER_ADDR:$DOMAIN_MASTER_PORT --command=/host=$HOST_NAME:shutdown

...
#export JAVA_OPTS=" $JAVA_OPTS -Djboss.modules.system.pkgs=org.jboss.byteman,com.opennaru.khan.agent,org.github.jamm,com.javaservice,scouter"
...
# for pinpoint setting
#export PINPOINT_AGENT_HOME=/svc/pinpoint/pinpoint-agent
#export JAVA_OPTS="$JAVA_OPTS -Djava.util.logging.manager=org.jboss.logmanager.LogManager"
#export JAVA_OPTS="$JAVA_OPTS -Djboss.modules.system.pkgs=org.jboss.logmanager,com.navercorp.pinpoint.bootstrap,com.navercorp.pinpoint.common,com.navercorp.pinpoint.exception"
#export JAVA_OPTS="$JAVA_OPTS -Xbootclasspath/p:$JBOSS_HOME/modules/system/layers/base/org/jboss/logmanager/main/jboss-logmanager-1.5.2.Final-redhat-1.jar"
#export JAVA_OPTS="$JAVA_OPTS -javaagent:$PINPOINT_AGENT_HOME/pinpoint-bootstrap-1.8.5.jar "
#export JAVA_OPTS="$JAVA_OPTS -Dpinpoint.agentId=user11 -Dpinpoint.applicationName=User11 "
#export JAVA_OPTS="$JAVA_OPTS -javaagent:/svc/pinpoint/pinpoint-agent/pinpoint-bootstrap-1.8.5.jar"

# mod_jk Turn OFF
#export HTTPD_HOSTS=( "222.231.44.164" "222.231.44.165" "222.231.44.173" "222.231.44.174" "222.231.44.144" "222.231.44.155"  )
#export LB_WORKER=user12
